...
pub fn test() {
    //let cornell_box = tobj::load_obj("./resources/models/vehicle-vintage-racer.obj", &tobj::GPU_LOAD_OPTIONS);
    let cornell_box = tobj::load_obj("./resources/models/Sting-Sword.obj", &tobj::GPU_LOAD_OPTIONS);
    match cornell_box {
        Err(e) => { panic!("{}",e)},
        _ => {}
    }
