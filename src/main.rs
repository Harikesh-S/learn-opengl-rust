...
fn main() {
    ...
    match tutorial_id.as_str() {
        ...
        #[cfg(feature = "chapter-4")] "4_4"   => main_4_4(),
        #[cfg(feature = "chapter-4")] "4_4_e"   => main_4_4_e(),
        #[cfg(feature = "chapter-4")] "4_5"   => main_4_5(),
