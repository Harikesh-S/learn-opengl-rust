/// Camera class that implements a Free cam, FPS cam (kind of) for 7-1-1, Free cam (custom lookat) for 7-1-2
/// can probably split the exercise cameras to different files
