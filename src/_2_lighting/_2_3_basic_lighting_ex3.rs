// Ex3 : Phong shading in view space
...
const MESSAGE : &str = "Chapter 2 : Part 2 : Ex3 : Phong shading in view space";
...
const LIGHT_LOCATION : glm::Vec3 = glm::Vec3::new(1.0, 0.0, 1.5);
...
pub fn main_2_2_3() {
    ...
    // Shader Program
    let default_shader = Shader::new("./src/_2_lighting/shaders/2_3_default.vert","./src/_2_lighting/shaders/2_3_default.frag");
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            let camera_view = glm::look_at_rh(&camera.position, &(camera.position + camera.direction), &camera.up); // calculating camera's view manually since its not in the class
            ...
            default_shader.set_mat4(c_str!("view"), camera_view);
