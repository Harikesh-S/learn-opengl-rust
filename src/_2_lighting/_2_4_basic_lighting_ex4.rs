// Ex 4 : Gourand Shading - phong shading in vertex shaader
// implemented on top of Ex1
// Ambient is mostly the same, diffuse works but feels lower res
// Specular produces a streak instead of a nice circle - probably since vertex shader is working on triangles with 3 points
...
const MESSAGE : &str = "Chapter 2 : Part 2 : Ex 4 : Gourand Shading - phong shading in vertex shaader, implemented on top of Ex1";
...
pub fn main_2_2_4() {
    ...
    // Shader Program
    let default_shader = Shader::new("./src/_2_lighting/shaders/2_4_default.vert","./src/_2_lighting/shaders/2_4_default.frag");
