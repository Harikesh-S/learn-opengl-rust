// Ex 1 : Messing around with light colors (ambient, diffuse, specular)
...
const MESSAGE : &str = "Chapter 2 : Part 4 : Ex 1 : Messing around with light colors (ambient, diffuse, specular) - press N to cycle";
...
// Lights to cycle through
const LIGHT_COLORS : [[glm::Vec3;3];6] = [
    [glm::Vec3::new(0.2, 0.2, 0.2), glm::Vec3::new(0.5, 0.5, 0.5), glm::Vec3::new(1.0, 1.0, 1.0)],
    [glm::Vec3::new(0.8, 0.8, 0.8), glm::Vec3::new(0.2, 0.2, 0.2), glm::Vec3::new(1.0, 1.0, 1.0)],
    [glm::Vec3::new(0.2, 0.2, 0.2), glm::Vec3::new(1.0, 1.0, 1.0), glm::Vec3::new(1.0, 1.0, 1.0)],
    [glm::Vec3::new(0.2, 0.0, 0.0), glm::Vec3::new(0.5, 0.0, 0.0), glm::Vec3::new(1.0, 0.0, 0.0)],
    [glm::Vec3::new(0.0, 0.2, 0.0), glm::Vec3::new(0.0, 0.5, 0.0), glm::Vec3::new(0.0, 1.0, 0.0)],
    [glm::Vec3::new(0.0, 0.0, 0.2), glm::Vec3::new(0.0, 0.0, 0.5), glm::Vec3::new(0.0, 0.0, 1.0)],
];
...
pub fn main_2_4_1() {
    ...
    // Shader Program
    let default_shader = Shader::new("./src/_2_lighting/shaders/4_0_default.vert","./src/_2_lighting/shaders/4_0_default.frag");
    ...
    while !window.should_close() {
        ...
        for (_, event) in glfw::flush_messages(&events) {
            ...
            match event {
                ...
                glfw::WindowEvent::Key(glfw::Key::N, _, glfw::Action::Press, _) => {
                    curr_light += 1;
                    if curr_light >= LIGHT_COLORS.len() {
                        curr_light = 0;
                    }
                    println!("ambient/diffuse/specualr:{:?}",LIGHT_COLORS[curr_light]);
                }
        ...
        unsafe {
            ...
            default_shader.set_vec3(c_str!("light.ambient"),  LIGHT_COLORS[curr_light][0]);      // low because we dont want amient color to be too dominant
            default_shader.set_vec3(c_str!("light.diffuse"),  LIGHT_COLORS[curr_light][1]);      // exact color that we want
            default_shader.set_vec3(c_str!("light.specular"),  LIGHT_COLORS[curr_light][2]);         // high because we want the light's color in the highlight
            ...
            light_shader.set_vec3(c_str!("lightColor"), LIGHT_COLORS[curr_light][2]);     // Materials Ex1
