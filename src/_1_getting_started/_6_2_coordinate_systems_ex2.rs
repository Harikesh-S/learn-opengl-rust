// Ex2 - Moving around the view matrix (camera)
// moved view around, cannot rotate yet
...
const MESSAGE : &str = "Chapter 1 : Part 6 : Ex 2 : Moving around the view matrix";
const WINDOW_WIDTH: u32 = 800;
const WINDOW_HEIGHT: u32 = 800;
const WINDOW_TITLE: &str = "Coordinate Systems - Ex2";
...
pub fn main_1_6_2() {
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            // updating transform
            let view = glm::translate(&glm::Mat4::identity(), &glm::vec3(2.0, 1.0, -5.0));
