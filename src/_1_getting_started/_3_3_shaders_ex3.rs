// Ex3 - set color equal to position between shaders for triangle
// bottom left of triangle is black since middle is 0,0,0 and colors below that are all black
...
const MESSAGE : &str = "Chapter 1 : Part 3 : Ex 3 : Set color equal to the vertex position";
const WINDOW_WIDTH: u32 = 800;
const WINDOW_HEIGHT: u32 = 800;
const WINDOW_TITLE: &str = "Shaders";

const VERTICES: [GLfloat; 18] = [
    // Vertices       // Colors
...
pub fn main_1_3_3() {
    ...
    let default_shader = Shader::new("./src/_1_getting_started/shaders/3_3_default.vert","./src/_1_getting_started/shaders/3_0_default.frag");
