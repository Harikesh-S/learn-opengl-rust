// Ex1 - Adjust vertex shader to make an upside down triangle
...
const MESSAGE : &str = "Chapter 1 : Part 3 : Ex 1 : Adjust vertex shader to invert triangle";
const WINDOW_WIDTH: u32 = 800;
const WINDOW_HEIGHT: u32 = 800;
const WINDOW_TITLE: &str = "Shaders - Ex1";
