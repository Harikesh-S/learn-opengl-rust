// Applying mvp transforms - refer draw function and shaders
// Additionally moving frame buffer resize to event handler
...
const MESSAGE : &str = "Chapter 1 : Part 6 : MVP transforms and going 3D";
const WINDOW_WIDTH: u32 = 800;
const WINDOW_HEIGHT: u32 = 800;
const WINDOW_TITLE: &str = "Coordinate Systems";
