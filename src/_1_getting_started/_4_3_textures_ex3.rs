// Ex3 - Only displaying pixels from center using tex coords
...
const MESSAGE : &str = "Chapter 1 : Part 4 : Ex 3 : Display the pixels in the center (zoom in)";
const WINDOW_WIDTH: u32 = 800;
const WINDOW_HEIGHT: u32 = 800;
const WINDOW_TITLE: &str = "Textures - Ex3";

const VERTICES: [GLfloat; 32] = [
    // Vertices       // Colors       // TexCoord
    -0.5, -0.5, 0.0,  0.0, 0.0, 1.0,  0.45, 0.45, // bottom left
     0.5, -0.5, 0.0,  0.0, 1.0, 1.0,  0.5 , 0.45, // bottom right
     0.5,  0.5, 0.0,  1.0, 1.0, 1.0,  0.5 , 0.5 , // top right
    -0.5,  0.5, 0.0,  1.0, 0.0, 1.0,  0.45, 0.5 , // top left 
];
...
pub fn main_1_4_3() {
    ...
    let default_shader = Shader::new("./src/_1_getting_started/shaders/4_0_default.vert","./src/_1_getting_started/shaders/4_0_default.frag");
