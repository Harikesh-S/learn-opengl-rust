// Applying transforms - refer draw function and shaders
...
const MESSAGE : &str = "Chapter 1 : Part 5 : Applying transforms";
const WINDOW_WIDTH: u32 = 800;
const WINDOW_HEIGHT: u32 = 800;
const WINDOW_TITLE: &str = "Transformations";
...
pub fn main_1_5() {
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            let rotate = glm::rotate(&translate, f32::to_radians(glfw.get_time() as f32), &glm::Vec3::z());
