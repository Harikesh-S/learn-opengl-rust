// Ex2 - draw two triangles using multiple VAOs
...
const MESSAGE : &str = "Chapter 1 : Part 2 : Ex 2 : Two triangles (multiple VAOs)";
const WINDOW_WIDTH: u32 = 800;
const WINDOW_HEIGHT: u32 = 800;
const WINDOW_TITLE: &str = "Hello Triangle - Ex2";
