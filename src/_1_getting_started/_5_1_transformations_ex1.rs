// Ex1 - order of transformations and their impact - changing order to rotate, then transalte
// since translation is applied after rotation, it moves to the side relative to the object after it has rotated?
// not sure how to explain it, local axis shifts when its rotated
// need to re-learn linear algebra to explain this properly
...
const MESSAGE : &str = "Chapter 1 : Part 5 : Ex 1 : Messing with the order of the transforms";
const WINDOW_WIDTH: u32 = 800;
const WINDOW_HEIGHT: u32 = 800;
const WINDOW_TITLE: &str = "Transformations - Ex1";
...
pub fn main_1_5_1() {
    ...
    let default_shader = Shader::new("./src/_1_getting_started/shaders/5_0_default.vert","./src/_1_getting_started/shaders/5_0_default.frag");
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            let rotate = glm::rotate(&transform, glfw.get_time() as f32, &glm::Vec3::z());
            let translate = glm::translate(&rotate, &glm::Vec3::new(0.5, -0.5, 0.0));
            default_shader.set_mat4(c_str!("transform"), translate); 
