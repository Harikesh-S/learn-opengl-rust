// Ex3 - Make every 3rd cube spin - done using model matrix
...
const MESSAGE : &str = "Chapter 1 : Part 6 : Ex 3 : Make every third cube spin using model matrix";
const WINDOW_WIDTH: u32 = 800;
const WINDOW_HEIGHT: u32 = 800;
const WINDOW_TITLE: &str = "Coordinate Systems - Ex3";
...
pub fn main_1_6_3() {
    ...
    let (mut current_width,mut current_height) = (WINDOW_WIDTH, WINDOW_HEIGHT);
    ...
    while !window.should_close() {
        ...
        for (_, event) in glfw::flush_messages(&events) {
            ...
            match event {
                glfw::WindowEvent::FramebufferSize(w, h) => unsafe {
                    ...
                    current_width = w as u32;
                    current_height = h as u32;
        ...
        unsafe {
            ...
            let projection = glm::perspective(current_width as f32/current_height as f32, f32::to_radians(45.), 0.1, 100.);
            ...
            while i < CUBE_POSITIONS.len() {
                ...
                let mut angle: f32 = 20. + i as f32;
                if i % 3 == 0 {
                    angle += glfw.get_time() as f32;
                }
                model = glm::rotate(&model, angle as f32, &glm::vec3(1.0, 0.3, 0.5));
