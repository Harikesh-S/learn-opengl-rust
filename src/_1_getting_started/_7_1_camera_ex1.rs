...
const WINDOW_TITLE: &str = "Camera - Ex1";

const VERTICES: [GLfloat; 20] = [
    // Vertices       // TexCoord
    -100.0, -0.5, -100.0,   0.0, 0.0,
     100.0, -0.5, -100.0,   10.0, 0.0,
     100.0, -0.5,  100.0,   10.0, 10.0,
    -100.0, -0.5,  100.0,   0.0, 10.0,
];
...
pub fn main_1_7_1() {
    ...
    // Camera
    let mut camera : FPSCamera = FPSCamera::new(glm::vec3(0.,2.,0.), 0., 0., 0., WINDOW_WIDTH, WINDOW_HEIGHT);
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            // drawing a single plane instead
